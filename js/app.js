...
const App = {
  ...
  navigate(page) {
    ...
    const titles = {
      ...
      penarikansaldo: 'Penarikan Saldo',
      penyesuaianshopee: 'Penyesuaian Shopee',
    ...
    const moduleMap = {
      ...
      penarikansaldo: typeof PenarikanSaldo !== 'undefined' ? PenarikanSaldo : null,
      penyesuaianshopee: typeof PenyesuaianShopee !== 'undefined' ? PenyesuaianShopee : null,
